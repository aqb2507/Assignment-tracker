...
import { deleteSubmission, getSubmissions, reset } from "../../features/submissions/submissionSlice";
              ...
              .map((submission) => (
                ...
                { submission.allotedmarks === "NA" ?
                 ( <div className="inline-flex rounded-md shadow-sm">
                  ...
                  : <p className=" font-mono font-bold text-xl text-teal-700 dark:text-gray-400">
                    {submission.feedback}
                  </p>   
}
                  <a
